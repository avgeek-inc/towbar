...
<AccordionGroup>
<Accordion title="Inspect service or datastore">
...
<Accordion title="Deploy service or datastore">
...
<Accordion title="Rollback service or datastore">
...
<Accordion title="Restart service or datastore">
...
<Accordion title="Start service or datastore">
...
<Accordion title="Stop service or datastore">

`towbar_workload_stop`

Stop an service/datastore runtime, making it unavailable. Inspect workload operations afterward for completion.
...
<Accordion title="Collect logs for service or datastore">
