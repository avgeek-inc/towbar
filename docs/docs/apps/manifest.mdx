...
| `secrets`, `externalSecrets`                                      | Required keys and an external-secret source; values stay outside Git.              | [Workload secrets](/docs/secrets/workload), [external secrets](/docs/secrets/external)    |
