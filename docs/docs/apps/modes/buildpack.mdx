...
The example uses an amd64 builder, a bounded context, and a workload cache. Validate the resulting image's process and health behavior before adding public routing.
