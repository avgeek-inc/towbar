...
icon: "/assets/integration-logos/slack.svg"
---

<img
  className="towbar-doc-brand-logo"
  src="/assets/integration-logos/slack.svg"
  alt=""
  aria-hidden="true"
/>
...
For a single workload, additional Slack channel IDs can be declared in its [manifest notification routing](/docs/deployment-manifest#route-notifications-for-one-service-or-datastore). Those appear read-only under the entity's **Monitor → Notifications** page after sync. Keep the bot token in YAML, never in the manifest. Rotate it by applying new YAML, restarting Towbar, and testing a destination before revoking the old token.

<div className="towbar-doc-screenshot">
  <div className="towbar-product-light">
    <img
      src="/assets/release-v2/slack-notifications-light.jpg"
      alt="Slack notification destinations and category subscriptions in Towbar."
      width="2560"
      height="1440"
      loading="lazy"
    />
  ...
  <div className="towbar-product-dark">
    <img
      src="/assets/release-v2/slack-notifications-dark.jpg"
      alt="Slack notification destinations and category subscriptions in Towbar."
      width="2560"
      height="1440"
      loading="lazy"
