...
icon: "/assets/integration-logos/telegram.svg"
---

<img
  className="towbar-doc-brand-logo"
  src="/assets/integration-logos/telegram.svg"
  alt=""
  aria-hidden="true"
/>
...
Service and datastore manifests can declare extra Telegram chat/topic destinations without storing the bot token. See [manifest notification routing](/docs/deployment-manifest#route-notifications-for-one-service-or-datastore). Rotate the bot token in YAML, restart, and test before discarding the old token.
