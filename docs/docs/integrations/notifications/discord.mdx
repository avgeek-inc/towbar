...
icon: "/assets/integration-logos/discord.svg"
---

<img
  className="towbar-doc-brand-logo"
  src="/assets/integration-logos/discord.svg"
  alt="Discord logo"
  aria-hidden="true"
/>
...
Additional Discord destinations for one service or datastore can be declared in its [manifest](/docs/deployment-manifest#route-notifications-for-one-service-or-datastore). Do not put webhook tokens in that manifest.

<div className="towbar-doc-screenshot">
  <div className="towbar-product-light">
    <img
      src="/assets/release-v2/discord-notifications-light.jpg"
      alt="Discord webhook IDs and category subscriptions in Towbar."
      width="2560"
      height="1440"
      loading="lazy"
    />
  ...
  <div className="towbar-product-dark">
    <img
      src="/assets/release-v2/discord-notifications-dark.jpg"
      alt="Discord webhook IDs and category subscriptions in Towbar."
      width="2560"
      height="1440"
      loading="lazy"
