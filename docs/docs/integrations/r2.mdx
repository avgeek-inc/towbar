...
Create an R2 bucket and access-key pair with permissions for the objects and prefix Towbar will manage. Use the account's R2 S3 API endpoint, not a public bucket URL. The credentials stay in `/etc/towbar/towbar.yml`; datastore manifests choose the backup destination and policy.
...
<div className="towbar-doc-screenshot">
  <div className="towbar-product-light">
    <img
      src="/assets/release-v2/r2-setup-light.jpg"
      alt="Cloudflare R2 integration settings in Towbar."
      width="2560"
      height="1440"
      loading="lazy"
    />
  ...
  <div className="towbar-product-dark">
    <img
      src="/assets/release-v2/r2-setup-dark.jpg"
      alt="Cloudflare R2 integration settings in Towbar."
      width="2560"
      height="1440"
      loading="lazy"
