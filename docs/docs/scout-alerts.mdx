...
<div className="towbar-doc-screenshot">
  <div className="towbar-product-light">
    <img
      src="/assets/guides/scout-alerts-light.webp"
  ...
  <div className="towbar-product-dark">
    <img
      src="/assets/guides/scout-alerts-dark.webp"
      alt="Scout alert rules and incidents"
      width="2160"
      height="1548"
      loading="lazy"
...
The sidebar shows active incidents in a red count. An orange count beside **Performance** shows servers, apps, and resources with fresh CPU, memory, or disk usage above 80%, even without configured alerts. Each entity counts once across its metrics and containers. Inactive agents, stale readings, and removed entities are excluded. Both counts refresh every 30 seconds and disappear at zero.

<div className="towbar-doc-screenshot">
  <div className="towbar-product-light">
    <img
      src="/assets/guides/alerts-light.webp"
      alt="Workspace alert rules with entity filters and current evaluation states."
      width="3200"
      height="2100"
      loading="lazy"
    />
  ...
  <div className="towbar-product-dark">
    <img
      src="/assets/guides/alerts-dark.webp"
      alt="Workspace alert rules with entity filters and current evaluation states."
      width="3200"
      height="2100"
      loading="lazy"
...
<div className="towbar-doc-screenshot">
  <div className="towbar-product-light">
    <img
      ...
      alt="Workspace incidents with active and resolved states, readings, and timestamps."
      width="3200"
      height="2100"
      loading="lazy"
    />
