...
Use the [Resource manifest](/docs/resources/manifest) to review every declaration field. Choose one of the individual [managed database guides](/docs/databases) below, or follow [Image resources](/docs/resources/image) for another OCI service. [Backups](/docs/backups) and [restores](/docs/restores) cover managed database recovery.
