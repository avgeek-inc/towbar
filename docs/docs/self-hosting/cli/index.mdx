...
<CardGroup cols={2}>
  ...
  >
    Preview onboarding, install the bundled release, or move to a reviewed
    stable release.
  </Card>
  <Card
...
| `towbar preview [--defaults]`          | Simulate installation onboarding without changing the host | No            | No                    |
