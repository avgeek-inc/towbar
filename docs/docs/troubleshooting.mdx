...
| Login works locally but fails behind a proxy | Towbar origin and trusted proxy hops             | Check [public origins](/docs/reference/environment-variables#public-origins) and rebuild browser assets after changing URLs |
