...
| Login works locally but fails behind HTTPS | Towbar public origin                             | Check [public origins](/docs/self-hosting/environment-variables#public-origins), validate the environment file, and restart Towbar after changing the origin |
