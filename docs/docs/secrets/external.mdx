...
```yaml title="In a service or datastore manifest"
externalSecrets:
...
<div className="towbar-doc-screenshot">
  <div className="towbar-product-light">
    <img
      ...
      alt="A service's Secrets page showing its Infisical project, environment slug, and secret path without revealing values."
      width="2560"
      height="1440"
      loading="lazy"
    />
  ...
  <p>
    A service's Runtime Secrets page shows the Infisical source selected by its
...
<div className="towbar-doc-screenshot">
  <div className="towbar-product-light">
    <img
      ...
      alt="A datastore's Secrets page showing its Doppler project and config without revealing values."
      width="2560"
      height="1440"
      loading="lazy"
    />
  ...
  <p>
    A datastore's Runtime Secrets page shows the Doppler source selected by its
...
Sync the manifest, then deploy the workload. External values are resolved at deployment and supplied as **runtime** variables for services, datastores, and Compose workloads. They are not supplied to builds or deployment hooks; use [Towbar-managed secrets](/docs/secrets/towbar) for those stages.
