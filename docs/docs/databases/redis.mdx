---
title: "Redis"
description: "Declare a Redis 8 datastore with password authentication, persistent data, and RDB recovery."
icon: "/assets/database-logos/redis.webp"
---

<img
  className="towbar-doc-brand-logo"
  src="/assets/database-logos/redis.webp"
  alt=""
  aria-hidden="true"
/>
...
```yaml title=".towbar/datastores/redis.datastore.yml" highlight={3,14-16,18}
id: redis
name: Redis
type: redis
container:
...
as `redis://:PASSWORD@redis:6379/0` in the service's runtime secrets. The optional
