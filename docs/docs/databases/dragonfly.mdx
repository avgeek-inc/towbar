---
title: "Dragonfly"
description: "Declare a Dragonfly 1.33 datastore with Redis-compatible access and verified snapshot recovery."
icon: "/assets/database-logos/dragonfly.svg"
---

<img
  className="towbar-doc-brand-logo"
  src="/assets/database-logos/dragonfly.svg"
  alt="Dragonfly logo"
  aria-hidden="true"
/>
...
the `application` network. Store the connection URL in the service's runtime
