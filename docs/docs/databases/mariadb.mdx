---
title: "MariaDB"
description: "Declare a MariaDB 11.8 datastore with explicit initialization variables and native recovery."
icon: "/assets/database-logos/mariadb.webp"
---

<img
  className="towbar-doc-brand-logo"
  src="/assets/database-logos/mariadb.webp"
  alt="MariaDB logo"
  aria-hidden="true"
/>
...
```yaml title=".towbar/datastores/mariadb.datastore.yml" highlight={3,14-19,21}
id: mariadb
name: MariaDB
type: mariadb
container:
...
credentials and its connection URL with the service, not in the datastore manifest.
