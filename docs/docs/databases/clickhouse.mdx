---
title: "ClickHouse"
description: "Declare a ClickHouse 25.8 datastore with an explicit user, database, private access, and native recovery."
icon: "/assets/database-logos/clickhouse.webp"
---

<img
  className="towbar-doc-brand-logo"
  src="/assets/database-logos/clickhouse.webp"
  alt=""
  aria-hidden="true"
/>
...
`clickhouse:8123`. Save credentials and the final connection URL in the service's
