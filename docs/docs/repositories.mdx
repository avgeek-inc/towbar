...
Search the branch picker by name when mapping an environment. It includes all branches available to the connected GitHub App, including branches beyond the first page of results.
