...
Open an service or datastore and choose **Monitor → Compare deployments**. Select a baseline and a deployment to compare, choose the observation window, and select **Compare deployments**.
...
<div className="towbar-doc-screenshot">
  <div className="towbar-product-light">
    <img
      src="/assets/release-v2/deployment-comparison-light.jpg"
      alt="Compare resource usage over equal periods after two deployments became ready."
      width="2560"
      height="1440"
      loading="lazy"
    />
  ...
  <div className="towbar-product-dark">
    <img
      src="/assets/release-v2/deployment-comparison-dark.jpg"
      alt="Compare resource usage over equal periods after two deployments became ready."
      width="2560"
      height="1440"
      loading="lazy"
