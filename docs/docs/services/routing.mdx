...
description: "Give a Service a domain and select how its certificate is validated."
---

A Service can run privately without `domains` or `tls`. Add a domain to an environment when it should receive public traffic, then point DNS at that environment's server:
