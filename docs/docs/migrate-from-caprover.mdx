...
| Prebuilt private image                   | Image Service or Datastore with the OCI registry integration            |
...
registry, backup, notification, or external-secret identities in the
protected Towbar configuration. Rotate credentials when practical instead of
...
Continue with [Your first deployment](/docs/getting-started), [Resources](/docs/datastores),
