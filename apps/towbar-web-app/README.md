...
reference.
Apps with Preview enabled expose branch environments, stable URLs, expiry,
latest deployment status, and an owner cleanup action. The owning Source also
shows all active Preview environments. Preview build and deployment secret
bindings are edited independently from production bindings.
