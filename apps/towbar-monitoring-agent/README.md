...
CGO_ENABLED=0 GOOS=linux GOARCH=amd64 go build -trimpath -ldflags='-s -w' -o ../../tmp/monitoring-agent/towbar-monitoring-linux-amd64 .
CGO_ENABLED=0 GOOS=linux GOARCH=arm64 go build -trimpath -ldflags='-s -w' -o ../../tmp/monitoring-agent/towbar-monitoring-linux-arm64 .
```
