...
const toolGroups: Record<string, string> = {
  ...
  source: "Repositories",
  workload: "Services and datastores",
  autodeploy: "Services and datastores",
